  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "hover:bg-card border-b border-border last:border-b-0",
    ...
    >
      ...
      <button
        ...
        className="flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity p-1 rounded-md hover:bg-red-50 text-muted-foreground hover:text-red-500"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed right-0 top-0 z-[70] h-full w-full sm:w-[420px] bg-card border-l border-border flex flex-col shadow-lg"
          >
            {/* Header */}
            <div className="flex items-center justify-between px-5 py-4 border-b border-border">
              <div className="flex items-center gap-2.5">
                ...
                {unreadCount > 0 && (
                  <span className="inline-flex items-center justify-center min-w-[20px] h-5 px-1.5 text-[11px] font-bold rounded-full bg-primary text-white">
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  disabled={isLoading}
                  className="p-2 rounded-lg hover:bg-card text-muted-foreground hover:text-foreground transition-colors disabled:opacity-50"
                  title="Refresh"
                >
            ...
            <div className="px-5 py-3 border-t border-border text-center">
              <button
                onClick={() => void fetchNow()}
                className="text-xs text-muted-foreground hover:text-[#3730a3] transition-colors"
              >
...
export function NotificationBell() {
  ...
  return (
    <button
      onClick={togglePanel}
      className="relative w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 text-muted-foreground hover:text-foreground hover:bg-card"
    >
