    ...
    return (
      <div
        ...
        className={cn(
          ...
          clickable && "cursor-pointer hover:bg-[#1e293b] hover:border-border",
        )}
      >
        {/* Avatar */}
        <div className={cn(
          "w-9 h-9 rounded-full flex-shrink-0 flex items-center justify-center text-xs font-bold text-foreground",
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className={cn(
            ...
            isUnread ? "text-slate-100 font-medium" : "text-muted-foreground",
          )}>
    ...
    >
        ...
        <div className="flex gap-4 flex-col lg:flex-row">
          ...
          <div className={cn("flex-1 min-w-0", selectedEmail && "hidden lg:block")}>
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                onClick={fetchInbox}
                className="text-xs text-muted-foreground hover:text-foreground transition-colors px-3 py-1.5 rounded-lg hover:bg-[#1e293b]"
              >
                Refresh
              </button>
            </div>
            ...
            {emails.length === 0 ? (
              <div className="bg-card border border-border rounded-xl p-12 text-center">
                <MailIcon className="w-10 h-10 text-muted-foreground mx-auto mb-3" />
            ...
            <div className="flex-1 min-w-0 bg-card border border-border rounded-xl overflow-hidden flex flex-col">
              ...
              <div className="flex items-center justify-between px-4 py-3 bg-card border-b border-border flex-shrink-0">
                ...
                <div className="flex items-center gap-1 ml-auto">
                  ...
                  <button
                    onClick={handleReply}
                    className="inline-flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground transition-colors px-3 py-1.5 rounded-lg hover:bg-[#1e293b]"
                    title="Reply"
                  >
                  ...
                  <button
                    onClick={handleCloseDetail}
                    className="text-muted-foreground hover:text-foreground transition-colors p-1.5 rounded-lg hover:bg-[#1e293b] hidden lg:block"
                  >
                    <X className="w-4 h-4" />
                  </button>
                </div>
                ...
                {detailLoading ? (
                  ...
                  <>
                    ...
                    {((emailDetail?.attachmentList?.length ?? 0) > 0) && (
                      <div className="mt-4 flex items-center gap-2 text-xs text-muted-foreground bg-card px-3 py-2 rounded-lg border border-border">
                    ...
                    {/* Email body */}
                    <div className="mt-5 text-sm text-foreground leading-relaxed">
                      {emailDetail?.messageHtml ? (
                        <div
                          className="prose prose-invert prose-sm max-w-none [&_a]:text-blue-600 [&_a]:underline [&_a:hover]:text-blue-300 [&_blockquote]:border-l-slate-500 [&_blockquote]:text-muted-foreground [&_pre]:bg-[#0f172a] [&_pre]:rounded-lg [&_pre]:p-4 [&_table]:border-collapse [&_td]:border [&_td]:border-border [&_td]:px-2 [&_td]:py-1 [&_th]:border [&_th]:border-border [&_th]:px-2 [&_th]:py-1 [&_th]:bg-card [&_th]:text-foreground [&_img]:max-w-full [&_img]:rounded-lg"
            ...
            <div className="p-5 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#0f172a] border border-slate-700 rounded-lg px-4 py-2.5 text-sm text-foreground placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500 transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#0f172a] border border-slate-700 rounded-lg px-4 py-2.5 text-sm text-foreground placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500 resize-y transition-colors"
                />
              </div>
              ...
              <button
                ...
                className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-500 disabled:bg-muted disabled:text-muted-foreground text-foreground px-5 py-2.5 rounded-lg text-sm font-medium transition-colors"
              >
                {sendingEmail && (
            ...
            <div className="flex gap-2">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full bg-[#0f172a] border border-slate-700 rounded-lg pl-10 pr-4 py-2.5 text-sm text-foreground placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500 transition-colors"
                />
              </div>
              <button
            ...
            <div className="bg-card border border-border rounded-xl p-12 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {["from:", "subject:", "has:attachment", "is:unread"].map((op) => (
                  <code
                    key={op}
                    className="bg-[#0f172a] px-2 py-1 rounded text-xs text-muted-foreground border border-border"
                  >
                    {op}
                  </code>
                ))}
      ...
      {gmTab === "labels" && !loading && (
        <div className="max-w-2xl space-y-6">
          ...
          <div className="bg-card border border-border rounded-xl overflow-hidden">
            <div className="px-5 py-4 bg-card border-b border-border">
              <h2 className="text-lg font-semibold text-foreground">Create Label</h2>
            </div>
            <div className="p-5">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-[#0f172a] border border-slate-700 rounded-lg px-4 py-2.5 text-sm text-foreground placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-red-500/50 focus:border-red-500 transition-colors"
                />
                <button
                  onClick={handleCreateLabel}
                  disabled={creatingLabel || !newLabelName.trim()}
                  className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-500 disabled:bg-muted disabled:text-muted-foreground text-foreground px-4 py-2.5 rounded-lg text-sm font-medium transition-colors"
                >
                ...
                {labels.map((label) => (
                  ...
                  >
                    <span className="flex items-center gap-2.5 text-sm">
                      ...
                      <span className="text-foreground font-medium truncate">{label.name}</span>
                    </span>
                    <span className={cn(
