          ...
          return (
            <button
              ...
              className={cn(
                ...
                "bg-[#faf9f7] border border-[#f0ede8]",
                "hover:bg-white hover:border-[#e8e5df]",
                isActive && "border-l-2 border-l-[#3730a3] bg-[#eef2ff]/50 border-t-[#e8e5df] border-r-[#e8e5df] border-b-[#e8e5df]"
              )}
            >
              {/* Avatar */}
