// ---------------------------------------------------------------------------
// Phase 5 Setup — Projects & Task Graph Tables
//
// Persistent project management: agents can break down projects into tasks,
// track dependencies, schedule execution, and continue from where they stopped.
//
// Tables: projects, project_tasks, project_task_logs
// ---------------------------------------------------------------------------
