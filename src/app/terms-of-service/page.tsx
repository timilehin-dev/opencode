...
export const metadata: Metadata = {
  title: "Terms of Service — Klawhub",
  description: "Klawhub Terms of Service. Read the terms and conditions governing your use of our AI agent platform.",
};
    ...
    <div className="min-h-screen bg-background">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="text-foreground/80">
          If you have any questions about these Terms of Service, please contact us at: <strong>legal@klawhub.xyz</strong>
        </p>
      </article>
