---
name: pdf
tags: [pdf, document, report, creative, academic, form-filling]
metadata:
  author: Z.AI
  version: "1.0"
  category: document
  difficulty: advanced
description: "Professional PDF toolkit with four production lines: (1) Report - structured documents via ReportLab (2) Creative - visual design via JSON Blueprint (3) Academic - scholarly work via LaTeX/Tectonic (4) Process - manipulate existing PDFs. Auto-routes based on document type."
license: Proprietary
---
